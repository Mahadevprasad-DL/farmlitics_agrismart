...
const Homepage = () => {
  ...
  return (
    <motion.div 
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="min-h-screen pt-20 bg-gradient-to-br from-black via-gray-800 to-black relative"
    >
      <Navbar />
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-blue-400 via-purple-500 to-orange-900 bg-clip-text text-transparent">
            Welcome to Farmlitics
          </h1>
