        ...
        <div className="flex items-center justify-between h-16 px-6 sm:px-8">
          ...
          <div className="hidden sm:flex items-center space-x-12">
            ...
            >
              <Link 
                to='/contact' 
                className="bg-gradient-to-r from-blue-400 to-purple-500 text-white px-6 py-2 rounded-full 
    ...
    >
            ...
            >
              ...
              >
                <Link
                  to="/contact"
                  className="block px-6 py-4 text-lg text-white bg-gradient-to-r from-orange-400 to-blue-500 
