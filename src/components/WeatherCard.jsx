      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 sm:gap-8 mb-6 sm:mb-8">
          <div className="text-center md:text-left">
            ...
            <p className="text-4xl sm:text-6xl font-bold bg-gradient-to-r from-purple-900 to-blue-500 bg-clip-text text-transparent">
